...
<head>
  ...
  <meta name="description" content="Halaman masuk untuk panel admin SiCegah Stunting Universitas Muhammadiyah Kalimantan Timur." />
...
<body class="login-bg flex items-center justify-center p-4">
  ...
  <div class="w-full max-w-md">
    ...
    <p class="text-center text-[11px] text-slate-400 mt-4 leading-relaxed">
      ...
      &copy; {{ date('Y') }} SiCegah Stunting — Universitas Muhammadiyah Kalimantan Timur
    </p>
  </div>
