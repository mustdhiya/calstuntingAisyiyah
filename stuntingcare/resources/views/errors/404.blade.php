  ...
  <main class="hero min-h-screen bg-gradient-to-br from-emerald-50 via-white to-cyan-50 px-4">
    <div class="hero-content text-center">
      <div class="max-w-xl">
        ...
        <p class="py-4 text-lg text-slate-600">Halaman yang Anda cari tidak ditemukan. Tautan mungkin berubah atau halaman belum tersedia.</p>
        <a href="{{ route('home') }}" class="btn btn-primary btn-lg rounded-full">Kembali ke Beranda</a>
      </div>
    </div>
  </main>
</body>
